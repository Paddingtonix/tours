...
export const twigRule = {
    ...
    use: [
        ...
        (info) => ({
            ...
            options: {
                namespaces: {
                    layouts: path.join(rootDir, 'src/templates/layouts'),
                    pages: path.join(rootDir, 'src/templates/pages'),
                    components: path.join(rootDir, 'src/templates/components'),
                    base: path.join(rootDir, 'src/templates/components/base'),
                    ui: path.join(rootDir, 'src/templates/components/ui-components'),
                },
                functions: {
                    t(value, text) {
                        return text;
